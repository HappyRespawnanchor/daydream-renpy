...
define gui.accent_color = '#ff878e'
...
## 用。
define gui.muted_color = '#ffadae'
define gui.hover_muted_color = '#ffd9da'
...
## 游戏内文本使用的字体。
define gui.text_font = "wenquanyiweimihei.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "Alibaba-PuHuiTi-Medium.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "wenquanyiweimihei.ttf"
